...
class _ChatScreenState extends State<ChatScreen> {
  ...
  static const apiKey = "AIzaSyCK_h5Df276sDAFM0JiA3ECN-tpPnN-oDs";
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
                ...
                image: NetworkImage('https://cdn.wallpapersafari.com/26/70/gouJBx.jpg'),
                fit: BoxFit.cover
            )
        ),
        child: Column(
...
class Messages extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          color: isUser ? Colors.green : Colors.black45,
